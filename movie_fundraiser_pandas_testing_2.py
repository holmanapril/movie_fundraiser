            ...
            if yes_no == "y" or yes_no == "yes":
                while not options:
                    ...
                    if user_choice >= 6 or user_choice < 0 or user_snack_amount > 5 or user_snack_amount < 1:
                        ...
                        if user_choice == 1:
                            user_list[3] += user_snack_amount
                        elif user_choice == 2:
                            user_list[4] += user_snack_amount
                        elif user_choice == 3:
                            user_list[5] += user_snack_amount
                        elif user_choice == 4:
                            user_list[6] += user_snack_amount
                        elif user_choice == 5:
                            user_list[7] += user_snack_amount
...
profit_each_order = []
profit_information_total = [["total profit", "amount of seats", 0, 0, 0, 0, 0]]
...
user_list_together.clear()
user_list_together.append(user_list)
user_list_together.append(user_list)
singular_ticket = pd.DataFrame(user_list_together, columns=["Name", "Ticket Amount", "Total Ticket Price", "Popcorn",
                                                            "M&M's", "Pita Chips", "Orange Juice", "Water",
                                                            "Snack Price", "Payment method", "Order total"])
pd.set_option("display.max_rows", None, "display.max_columns", None, "display.expand_frame_repr", False)
print(singular_ticket)
# print()
# print(singular_ticket.to_csv(index=False))
...
# singular_ticket.to_csv('ticket_details.csv', header=False)
# type(ticket_details)
